...
public class SampleController {
	...
	public void basic2() {
		log.info("basic2...");
		// 반환값이 없음 : /sample/page2 => /WEB-INF/views/sample/page1.jsp
	}
	...
	public String ex02(SampleDTO dto, Model model, int score) {
		...
		model.addAttribute("score", score);	// 참조값을 담아서 반환. request.setAttribute("age", dto.getAge());
